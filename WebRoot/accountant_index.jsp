...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="servlet/accountantServlet?type=listpersonal" target="right"><span class="icon-caret-right"></span>个人信息管理</a></li>
    <li><a href="servlet/orderingServlet?type=listexpenditure" target="right"><span class="icon-caret-right"></span>消费统计</a></li>
  </ul> 
