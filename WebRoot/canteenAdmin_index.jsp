...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="servlet/menuServlet?type=list" target="right"><span class="icon-caret-right"></span>菜单管理</a></li>
    <li><a href="servlet/canteenAdminServlet?type=listpersonal" target="right"><span class="icon-caret-right"></span>个人信息管理</a></li>  
  </ul> 
