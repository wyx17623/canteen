...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form id="loginForm" action="<%=path %>/servlet/loginServlet" method="post">
            <div class="panel loginbox">
                <div class="text-center margin-big padding-big-top"><h1>食堂管理系统</h1></div>
                ...
                &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<input type="radio" name="type" value="2"checked="checked">管理员
                &nbsp; &nbsp;&nbsp;&nbsp;  <input type="radio" name="type"value="3">出纳
                  &nbsp; &nbsp;&nbsp;&nbsp;<input type="radio" name="type"value="4">采购员
                   &nbsp; &nbsp;&nbsp;&nbsp;  <input type="radio" name="type"value="5">会计
