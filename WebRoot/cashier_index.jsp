...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="servlet/cashierServlet?type=listpersonal" target="right"><span class="icon-caret-right"></span>个人信息管理</a></li>
    <li><a href="servlet/shoppinglistServlet?type=listreview" target="right"><span class="icon-caret-right"></span>采购审核</a></li>
