  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
       <li> <a class="button border-main icon-plus-square-o" href="page/menu/menu_add.jsp"> 添加菜单信息</a> </li>
         ...
         <th>操作</th>
			...
			<tr>
				...
				<div class="button-group">
				 <a class="button border-main" href="<%=path%>/page/menu/menu_update.jsp?index=<%=index-2%>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="<%=path%>/servlet/menuServlet?type=remove&menuID=<%=menuID%>" ><span class="icon-trash-o"></span> 删除</a>  </div>
				</td>
			</tr>
	<%} %>
    </table>
