...
<!--                        此页面为采购员点击左侧采购管理的界面，显示审核通过的采购清单 -->
<body>
  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
       <li> <a class="button border-main icon-plus-square-o" href="servlet/shoppinglistServlet?type=updatelist"> 采购清单管理</a> </li>
      </ul>
    </div>
    <table class="table table-hover text-center">
			...
			<tr>
				...
				<div class="button-group">
				 <a class="button border-main" href="servlet/detaillistServlet?type=list&shoppingID=<%=shoppingID%>"><span class="icon-edit"></span>查看明细</a>  </div>
				</td>
			</tr>
	<%} %>
    </table>
